...
function PartTwo() {
    ...
    const [moviesarray, setMoviesArry] = useState([
        {image : '/images/mowgli.jpg', id: "mowgli"},
        {image: '/images/happy.jpg' , id: 'thepursuitofhappiness'},
        {image: '/images/icare.jpg' , id: 'icarealot'},
        {image: '/images/lucifer.jpg' , id: 'lucifer'},
        {image: '/images/lupin.jpg' , id: 'lupin'},
        {image: '/images/money.jpg' , id: 'moneyheist'},
        {image: '/images/moon.png' , id: 'overthemoon'},
        {image: '/images/feel.jpg' , id: 'feelthebeat'},
    ...
    return (
        <PartOneContainer>
            <h4>Critically Acclaimed Dramas</h4>
            <Icons>
                {slideNo != 0 && (
                    <Left>
